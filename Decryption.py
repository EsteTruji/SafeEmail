...
class FileDecryptor:
    ...
    def decrypt(self):
        ...
        with open(self.encrypted_filename, 'rb') as file:
            ...
            receptor = ciphertext.split(b'*##$$&&//*:)')[0]
            receptor = base64.b64decode(receptor)
            ciphertext = ciphertext.split(b'*##$$&&//*:)')[1]
        try:
        ...
        clave_bytes = self.key.encode('utf-8')
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 4:
        print("\033[0;33mUse: python decryption.py <encrypted_file> <key> <second_key>\033[0m")
        sys.exit(1)
